...
import org.androidpn.client.customiq.SetTagsIQ;
    ...
    public void startService() {
        Thread serviceThread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Log.e("serviceThread", "startService");
            }
        });
        serviceThread.start();
    }
    	...
    	new Thread(new Runnable() {
			...
			public void run() {
				try {
					new Thread();
					Thread.sleep(1000);
					Log.d("Thread.sleep(1000);", "Thread.sleep(1000);");
    				...
    				if(!xmppManager.isAuthenticated()){ 
    					synchronized (xmppManager) {
    						try {
								...
								Log.d("xmppManager InterruptedException", e.toString());
								e.printStackTrace();
							}
						}
    				}
    				Log.e(LOGTAG, "authenticated already send AliasIQ...");
    				SetAliasIQ aliasIQ=new SetAliasIQ();
        	    	aliasIQ.setType(IQ.Type.SET);
    	...
    	new Thread(new Runnable() {
			...
			public void run() {
    			...
    			if(xmppManager!=null){
    				...
    				Log.e(LOGTAG, "authenticated already send TagsIQ...");
