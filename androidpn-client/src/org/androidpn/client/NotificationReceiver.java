...
public final class NotificationReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Constants.ACTION_SHOW_NOTIFICATION.equals(action)) {
            ...
            String notificationTime=intent.getStringExtra(Constants.NOTIFICATION_TIMA);
            ...
            Log.d(LOGTAG, "notificationTime=" + notificationTime);
            Log.d(LOGTAG, "notificationImageUrl=" + notificationImageUrl);

            Notifier notifier = new Notifier(context);
            notifier.notify(notificationId, notificationApiKey,
                    notificationTitle, notificationMessage, notificationUri,notificationTime,notificationImageUrl);
        }
